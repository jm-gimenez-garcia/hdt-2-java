 ...
 *
 */
public class GraphsFourSectionDictionaryBig extends BaseGraphsDictionary {

    public GraphsFourSectionDictionaryBig(final HDTOptions spec,
	...
	this.graphs = new PFCDictionarySectionBig(spec);
    }
	...
	header.insert(rootNode, HDTVocabulary.DICTIONARY_NUMGRAPHS, this.getNgraphs());
