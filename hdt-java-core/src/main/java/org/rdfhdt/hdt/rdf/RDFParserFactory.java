...
public class RDFParserFactory {
    ...
    public static RDFParserCallback getParserCallback(final RDFNotation notation) {
	...
	if (notation == RDFNotation.NQUADS || notation == RDFNotation.NTRIPLES || notation == RDFNotation.TURTLE || notation == RDFNotation.N3
		|| notation == RDFNotation.RDFXML) {
