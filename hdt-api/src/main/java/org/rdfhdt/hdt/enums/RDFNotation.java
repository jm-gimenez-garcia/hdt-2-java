...
public enum RDFNotation {
     ...
     * NQUADS notation
     *
     * @see <a href="https://en.wikipedia.org/wiki/N-Triples#N-Quads">Wikipedia</a>
     */
    NQUADS,
    /**
     * TURTLE notation
	...
	if (str == null || str.isEmpty()) { return NTRIPLES; }
	str = str.toLowerCase();
	if (str.equals("ntriples") || str.equals("nt")) {
	    return NTRIPLES;
	} else if (str.equals("nquads") || str.equals("nq")) {
	    return NQUADS;
	    ...
	    return RAR;
	} else if (str.equals("tar") || str.equals("tgz") || str.equals("tbz") || str.equals("tbz2")) { return TAR; }
	throw new IllegalArgumentException();
    }

    public static RDFNotation guess(final String fileName) throws IllegalArgumentException {
	String str = fileName.toLowerCase();

	final int idx = str.lastIndexOf('.');
	if (idx != -1) {
	    final String ext = str.substring(idx + 1, str.length());
	...
	if (str.endsWith("nt")) {
	    ...
	    return TAR;
	} else if (str.endsWith("rar")) { return RAR; }
	throw new IllegalArgumentException("Could not guess the format for " + fileName);
    }

    public static RDFNotation guess(final File fileName) throws IllegalArgumentException {
