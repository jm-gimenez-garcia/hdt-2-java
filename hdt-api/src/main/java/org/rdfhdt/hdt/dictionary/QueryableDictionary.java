 ...
 * 
 */
public interface QueryableDictionary<T extends DictionarySection> extends Dictionary<T> {
	...
	/**
	 * Returns the number of elements in the section of the dictionary.
	 */
	long getNumberOfElements(DictionarySectionRole section);
	
	/**
	 * Returns the number of predicates in the dictionary.
	 */
	long getNumberOfElements(TripleComponentRole role);
